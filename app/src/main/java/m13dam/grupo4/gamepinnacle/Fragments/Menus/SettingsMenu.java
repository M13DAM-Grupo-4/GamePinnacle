...
public class SettingsMenu extends Fragment {
    ...
    private EditText usuario_nuevo;
    private EditText contraseña_nueva_uno;
    private EditText contraseña_nueva_dos;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        usuario_nuevo = view.findViewById(R.id.nuevo_usuario);
        contraseña_nueva_uno = view.findViewById(R.id.nueva_contraseña);
        contraseña_nueva_dos = view.findViewById(R.id.register_password_repeated_text);
        ...
        botonCambiarContraseña.setOnClickListener(v -> {
            ...
            if(contraseña__uno.equals(contraseña__dos)){
